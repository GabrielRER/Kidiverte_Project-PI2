...
export class ProductDetail implements OnInit {
  ...
  private updateRatingInfo(): void {
    ...
    this.product.rating = this.averageRating;
  }
  ...
  private updateUserRating(): void {
    ...
    if (currentUser) {
      const userRating = this.ratingService.getUserRatingForProduct(currentUser.id, this.product.id);
      if (userRating) {
        this.product.rating = userRating.rating;
      }
    }
  }
